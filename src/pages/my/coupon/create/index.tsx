  ...
  class CreateCoupon extends Component<any> {
    ...
    handleSelectType = () =>
      ActionSheet.showActionSheetWithOptions({ options: types }, type =>{
        ...
        this.props.dispatch({type: 'createCoupon/setGift', payload: {gift: [], gift_number: ''}})
    ...
    postMoney = () =>
      ...
      request({
        ...
        data: {
          ...
          is_ad: this.props.location.query.isAd,
          limit_purchase_quantity: this.props.moneyForm.isLimit ? this.props.moneyForm.limit_purchase_quantity : 0,
          /**商圈广告下，购买价格为0 */
